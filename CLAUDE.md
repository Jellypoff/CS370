...
- Get explicit permission from me(user) to commit.
- Ensure every diff is compact and warn the user when it looks too large.
- Verify mutual understanding of a code change/bug fix with me(the user).
## Process Artifacts
Keep development aligned with the assignment's required process artifacts:
CLAUDE.md
PROMPTLOG.md
REFLECTION.md
raw Claude Code .jsonl transcripts
Git history